...
public class DBConstants {
    ...
    public static final String GET_LAST_TICKETS = "select count(t.ID) nbT from ticket t where t.VEHICLE_REG_NUMBER= ? and DATE(t.IN_TIME) BETWEEN DATE_ADD(CURRENT_DATE(), INTERVAL -7 DAY) and CURRENT_DATE() and t.PRICE > 0";
}
